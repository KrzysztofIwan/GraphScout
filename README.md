...
Projekt skupia się w obecnej chwili nad nawigacją po Tatrach Polskich, *oraz jest w fazie rozojowej co oznacza że może popełniać błędy.* **Zawsze należy dodatkowo sprawdzić poprawność danych aby wykluczyć możliwe halucynajce**.
